...
def extract_feature_values(data):
    ...
    EXPECTED_FEATURES = ['yr_adminst', 'region', 'msa', 'evr_smoked_cig',
       ...
       'drive_freq', '12mo_r_tcktd', '12mo_accidents']
    ...
    values = [[]]
    # checkbox_feats = ['has_father', 'has_mother', 'has_siblings',
    #                   'desire_tech_school', 'desire_military', 'desire_2yrcoll',
    #                   'desire_4yrcoll', 'desire_gradsch', 'desire_none']
